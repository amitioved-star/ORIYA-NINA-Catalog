  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-14">
      ...
      <div className="mt-10 text-center">
        <a className="btn-whatsapp inline-flex" href={buildWhatsappUrl('שלום, יש לי שאלה לגבי השכרת שמלה')} target="_blank" rel="noopener noreferrer">שאלה נוספת בוואטסאפ</a>
      </div>
    </div>
  )
}
